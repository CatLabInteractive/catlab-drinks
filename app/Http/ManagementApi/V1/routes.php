...
$routes->group(
	...
	function(RouteCollection $routes)
	{
		...
		\App\Http\ManagementApi\V1\Controllers\PublicCardNameController::setRoutes($routes);
		...
		$routes->group(
			...
			function(RouteCollection $routes) {
				\App\Http\ManagementApi\V1\Controllers\PublicController::setRoutes($routes);
			}
		);

		// Device connect controller handles its own authentication
		\App\Http\ManagementApi\V1\Controllers\DeviceConnectController::setRoutes($routes);
		...
		$routes->group(
			...
			function(RouteCollection $routes)
			{
				 ...
				 */
				\App\Http\ManagementApi\V1\Controllers\UserController::setRoutes($routes);
				\App\Http\ManagementApi\V1\Controllers\EventController::setRoutes($routes);
				\App\Http\ManagementApi\V1\Controllers\MenuController::setRoutes($routes);
				\App\Http\ManagementApi\V1\Controllers\OrderSummaryController::setRoutes($routes);
				\App\Http\ManagementApi\V1\Controllers\OrganisationController::setRoutes($routes);
				\App\Http\ManagementApi\V1\Controllers\FinancialOverviewController::setRoutes($routes);
				\App\Http\ManagementApi\V1\Controllers\TopupController::setRoutes($routes);
