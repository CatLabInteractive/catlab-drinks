...
use App\Http\ManagementApi\V1\ResourceDefinitions\CategoryResourceDefinition;
 ...
 */
abstract class CategoryController extends ResourceController
{
    const RESOURCE_DEFINITION = CategoryResourceDefinition::class;
