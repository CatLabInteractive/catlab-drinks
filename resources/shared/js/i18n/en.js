export default {
    ...
    'Allow unpaid table orders (waiter can open a tab)': 'Allow unpaid table orders (waiter can open a tab)',
    'Table orders are prepared by the bar (waiters only deliver)': 'Table orders are prepared by the bar (waiters only deliver)',
    'Tables': 'Tables',
    'No Table': 'No Table',
    'Unlinked patrons': 'Unlinked patrons',
    'Order Queue': 'Order Queue',
    'Unlinked Patrons': 'Unlinked Patrons',
    'Patrons at {table}': 'Patrons at {table}',
    'Patron': 'Patron',
    'Unpaid': 'Unpaid',
    'No patrons at this table.': 'No patrons at this table.',
    'New Patron': 'New Patron',
    'Back to patron list': 'Back to patron list',
    'Outstanding Balance': 'Outstanding Balance',
    'Pay Outstanding Balance': 'Pay Outstanding Balance',
    'No orders for this patron.': 'No orders for this patron.',
    'New Order': 'New Order',
    'Payment processed successfully.': 'Payment processed successfully.',
    'Items': 'Items',
    'This terminal is used by a waiter for table service. Cannot be combined with live or remote orders.': 'This terminal is used by a waiter for table service. Cannot be combined with live or remote orders.',
    'Allow table service at this terminal': 'Allow table service at this terminal',
    'My orders only': 'My orders only',
    'Prepared only': 'Prepared only',
    'Prepared': 'Prepared',
    'Delivered': 'Delivered',
    'Void': 'Void',
    'Requester': 'Requester',
    'Are you sure you want to void this order?': 'Are you sure you want to void this order?',
    'Pay later': 'Pay later',
    'Pay all outstanding orders for this patron?': 'Pay all outstanding orders for this patron?',
    'Generate tables': 'Generate tables',
    'Generate': 'Generate',
    'No tables configured for this event. Use the generate button above to create tables.': 'No tables configured for this event. Use the generate button above to create tables.',
    '#': '#',
    'Are you sure you want to remove this table?': 'Are you sure you want to remove this table?',
};
